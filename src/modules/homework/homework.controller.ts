...
export class HomeworkController {
  ...
  @ApiOperation({
    summary: 'Uyga vazifa uchun fayl yuklash (ADMIN, SUPERADMIN, MENTOR)',
  })
  @ApiResponse({ status: 201, description: 'Fayl yuklandi' })
  uploadHomeworkFile(@UploadedFile() file: Express.Multer.File | undefined) {
    if (!file) {
  ...
  @ApiOperation({
    summary:
      "Darsga topshiriq yaratish (ADMIN, SUPERADMIN, MENTOR — o'z kursi)",
  })
  ...
  @ApiResponse({
    status: 409,
    description: 'Bu darsda allaqachon topshiriq mavjud',
  })
  ...
  @ApiOperation({
    summary: "Topshiriqni tahrirlash (ADMIN, SUPERADMIN, MENTOR — o'z kursi)",
  })
  ...
  @ApiParam({ name: 'id', type: Number })
  @ApiOperation({
    summary: "Topshiriqni o'chirish (ADMIN, SUPERADMIN, MENTOR — o'z kursi)",
  })
