...
export class PurchasedCourseController {
    ...
    @ApiOperation({ summary: 'Kurs sotib olish yozuvini yaratish (ADMIN, SUPERADMIN)' })
    @ApiResponse({ status: 201, description: 'Yozuv yaratildi' })
    @ApiResponse({ status: 404, description: 'Foydalanuvchi, kurs yoki mentor topilmadi' })
    @ApiResponse({ status: 409, description: 'Foydalanuvchi ushbu kursni allaqachon sotib olgan' })
