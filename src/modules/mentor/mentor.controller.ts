...
export class MentorController {
    ...
    @ApiResponse({ status: 200, description: 'Studentlar ro\'yxati (progress bilan)' })
    ...
    @ApiParam({ name: 'submissionId', type: Number, description: 'Submission ID' })
    ...
    @ApiQuery({ name: 'courseId', required: false, type: Number, description: 'Kurs bo\'yicha filter' })
    @ApiQuery({ name: 'unread', required: false, enum: ['true', 'false'], description: 'Faqat o\'qilmaganlar' })
